...
RSpec.describe User, type: :model do
  it "should be created with password and password_confirmation fields" do
    user = User.new({ password: "test", password_confirmation: "test" , first_name: "first", last_name: "last", email: "test@test.com"})
    expect(user).to be_valid

  end
  it "should not be created with non-matching password" do
    user = User.new({ password: "test", password_confirmation: "wrong", first_name: "first", last_name: "last", email: "test@test.com"})
